    ...
    <div className="page-enter" style={{
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '36px 24px', position: 'relative', zIndex: 1 }}>
        ...
        <div className="theme-surface card-hover" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 18, flexWrap: 'wrap' }}>
            <div style={{ maxWidth: 560 }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '7px 12px', borderRadius: 999, background: 'rgba(20,184,166,0.08)', border: '1px solid rgba(20,184,166,0.18)', color: '#0d9488', fontSize: 12, fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: 12 }}>
                <span>🎤</span> Voice Mock Interview
              </div>
              <h3 style={{ color: '#0f172a', fontSize: 22, fontWeight: 800, margin: '0 0 8px' }}>Answer out loud, get scored like a real panel.</h3>
              <p style={{ color: 'rgba(15,23,42,0.58)', fontSize: 14, lineHeight: 1.7, margin: 0 }}>
                Gemini asks questions for your target role, reads them aloud, listens to your spoken answers, and gives per-question feedback plus a full report.
              </p>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, minWidth: 220 }}>
              <button onClick={() => navigate('/interview')} className="interactive" style={{
                padding: '12px 18px', borderRadius: 14,
                background: 'linear-gradient(135deg,rgba(20,184,166,0.94),rgba(14,165,233,0.84))',
                border: '1px solid rgba(20,184,166,0.24)', color: 'white',
                fontWeight: 800, cursor: 'pointer'
              }}>
